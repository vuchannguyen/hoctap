		...
		<tr class="krow1">
			<td valign="top" class="kprofileboxcnt">
				...
				<form action="<?php echo KunenaRoute::_(KUNENA_LIVEURLREL) ?>" method="post" name="login">
					<div class="input">
						<span>
							<label><?php echo JText::_('COM_KUNENA_A_USERNAME'); ?></label>
							<input type="text" name="<?php echo $login['field_username']; ?>" class="inputbox ks" alt="username" size="18" />
						</span>
						<span>
							<label><?php echo JText::_('COM_KUNENA_PASS'); ?></label>
						...
						<span>
							...
							<label class="remember"><?php if(JPluginHelper::isEnabled('system', 'remember')) : ?>
