...
/**
 * ------------------------------------------------------------------------
 * JA Accordion Module for Joomla 2.5
 * ------------------------------------------------------------------------
...
class articlesAdapter
{
    ...
    public static function getArticles($artIds = array(), $catIds = array(), &$params)
    {
        ...
        $model->setState('list.select', 'a.id, a.title, a.alias, a.title_alias, a.introtext, a.fulltext,' . 'a.checked_out, a.checked_out_time, ' . 'a.catid, a.created, a.created_by, a.created_by_alias, ' . // use created if modified is 0
