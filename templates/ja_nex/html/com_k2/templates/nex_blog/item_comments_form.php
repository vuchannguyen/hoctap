...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" id="comment-form" class="form-validate">
	<fieldset class="groupinput">
	<p>
    <label class="formName" for="userName"><strong><?php echo JText::_('K2_NAME'); ?></strong> <span class="required">*</span></label>
    ...
    <p>
	<label class="formEmail" for="commentEmail"><strong><?php echo JText::_('K2_EMAIL'); ?></strong> <span class="required">*</span></label>
    ...
    <p>
	<label class="formUrl" for="commentURL"><strong><?php echo JText::_('K2_WEBSITE_URL'); ?></strong></label>
    ...
    <p class="txtarea">
	<label class="formComment" for="commentText"><strong><?php echo JText::_('K2_MESSAGE'); ?></strong> <span class="required">*</span></label>
