		...
		<!-- Expan form-->
			<div class="jac-expand-form clearfix">				
				...
				<div class="form-userdata clearfix">
					<!-- BEGIN TEXT NAME-->
					<div class="jac-form-guest clearfix">
				...
				<li class="clearfix">
					...
					<div id="jac-new-captcha">
						<div class="new-captcha clearfix">
						...
						<div class="type_captcha jac-form-guest clearfix"><span><?php echo JText::_("TEXT_INPUT_CAPTCHA");?><span id="required_4" class="required">&nbsp;<?php echo JText::_("TEXT_REQUIRED");?></span>
