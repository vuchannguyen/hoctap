...
<div id="ja-zinfp-<?php echo $module->id?>" class="ja-zinfp clearfix">
	...
	<div class="ja-zinfp-main clearfix">
		...
		<div class="ja-zinfp-normal clearfix">
			<?php }?>
		<?php }else{?>
			<div class="ja-zincontent-wrap" <?php if($i%3==0 and $i>2): echo 'style="clear: both;"'; endif; ?>>
...
/* <![CDATA[ */
	window.addEvent('load', function() {
		new JANEWSFP_DEFAULT({'moduleid': <?php echo $module->id?>, 'animType': '<?php echo $animType?>', 'duration': <?php echo $duration?>, 'autoplay':<?php echo $autoplay?>, 'autoplay_duration':<?php echo $autoplay_duration?>, 'top_t': <?php echo ($bigimageheight - 40);?>, 'width_w':<?php echo $bigimagewidth;?>});
